...
def plt_mix():
    ...
    plt_util.plt_multi_line(embedding_rate, sizes_by_embedding, legends, "embeddings coverage rate (%)", "index size (bytes)",
                            [0], "", "lower right", (6,5))
    ...
    plt_util.plt_multi_line(embedding_rate, times_by_embedding, legends, "embeddings coverage rate (%)", "index build time (s)",
                            [0], "", "lower right", (6,5))
...
def plt_main():
    ...
    plt_util.plt_2d(path_len, ORI_sizes[5], "traversal depth in building index", "CSM-Index index size (bytes)")
    ...
    plt_util.plt_multi_line(path_len, times, legends, "traversal depth in building index", "index build time (s)", [],
                            "", "upper left", (6,5))
